...
export class AuthService {
  ...
  getToken(): string {
    return this.cookieService.get('dexter_access_token') || '';
  }

  isLoggedIn(): boolean {
    return this.cookieService.hasKey('dexter_access_token');
  }

  public doLogout(): void {
    const removeToken = this.cookieService.remove('dexter_access_token');
    if (removeToken == null) {
