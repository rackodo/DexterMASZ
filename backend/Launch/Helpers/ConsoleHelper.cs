...
public static class ConsoleHelper
{
    ...
    public static KeyValuePair<DatabaseSettings, bool> CreateDatabaseSettings()
    {
        ...
        return new KeyValuePair<DatabaseSettings, bool>(new DatabaseSettings
        {
            Database = database,
            Host = host,
            Port = port,
    ...
    public static KeyValuePair<string, bool> AskAndSet(string name, string envVar)
    {
        ...
        if (GetEnvironmentalVariable(envVar) != option)
        {
            ...
            return new KeyValuePair<string, bool>(option, true);
        }

        return new KeyValuePair<string, bool>(option, false);
    }
