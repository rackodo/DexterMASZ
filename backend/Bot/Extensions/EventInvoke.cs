...
public static class EventInvoke
{
    ...
    private static ArgumentNullException CreateNotNullException(string name, string msg) =>
        msg is null ? new ArgumentNullException(name) : new ArgumentNullException(name, msg);
    ...
    public static void Invoke<T1, T2, T3, T4>(this AsyncEvent<Func<T1, T2, T3, T4, Task>> eventHandler, T1 arg1,
        T2 arg2,
        T3 arg3, T4 arg4)
    {
        foreach (var subscription in eventHandler.Subscriptions)
