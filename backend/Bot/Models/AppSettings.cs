...
public class AppSettings
{
    ...
    public string EmbedContent { get; set; } =
        "Dexter is a moderation bot. Keep track of all moderation events on your server, search reliably for infractions or setup automod to be one step ahead of rule breakers.";
    ...
    public string GetEmbedData(string url) =>
        ...
        (string.IsNullOrWhiteSpace(EmbedContent)
            ? ""
