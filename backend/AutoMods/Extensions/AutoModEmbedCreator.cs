...
public static class AutoModEmbedCreator
{
        ...
        IUser user, ITextChannel channel, IServiceProvider provider, PunishmentType? punishmentType = null)
    {
        ...
        if (autoModEvent.AutoModAction is AutoModAction.CaseCreated or AutoModAction.ContentDeletedAndCaseCreated &&
            punishmentType != null)
        ...
        IUser actor, RestAction action, IServiceProvider provider)
    {
        ...
        embed.AddField(
            ...
            (autoModConfig.AutoModAction is AutoModAction.ContentDeleted or AutoModAction.ContentDeletedAndCaseCreated)
            .GetCheckEmoji(),
            true);
